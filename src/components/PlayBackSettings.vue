<template>
  <div
    class="absolute right-6 w-72 bg-white dark:bg-indigo-900 shadow rounded z-50 flex flex-col gap-2 p-4"
  >
    <div class="flex justify-between items-center">
      ...
      <div>
        ...
        <input
          ...
          class="text-center border size-10 rounded-lg"
          min="1"
          max="8"
        />
      </div>
