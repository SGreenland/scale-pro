...
// };
export const notePatterns: NotePattern[] = [
...
export const lockedPatterns: string[] = ['Whole Tone', 'Diminished', 'Blues Scale', 'Phrygian', 'Lydian', 'Mixolydian', 'Locrian', 'Diminished 5th', 'Augmented 5th'];
